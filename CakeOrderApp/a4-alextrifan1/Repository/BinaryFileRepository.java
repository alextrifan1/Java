...
//        super();
        ...
        try {
            ...
            throw new RuntimeException(e); ///!!! prima data cand faci comentezi exceptia ca arunca eoarea cand e gol fisierul
        }
    }


    @Override
    public void add(T o) throws DuplicateEntityException, IOException, RepositoryException {
        super.add(o);
    ...
    private void loadFile() throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            this.entities = (List<T>) ois.readObject();
